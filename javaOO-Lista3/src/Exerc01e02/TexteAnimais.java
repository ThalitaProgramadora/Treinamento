...
public class TexteAnimais {
	...
	public static void main(String[] args) {
		...
		if(cont.equals("c") || cont.equals("C")) {
			...
			Cachorro.setIdade(i);
			int opcao =Integer.parseInt(JOptionPane.showInputDialog(null,"Gostaria de ouvir o som: 1- LATIDO ou 2-CORRE: "));
			if(opcao ==1) {
			...
			i = Integer.parseInt(a);
			Cavalo.setIdade(i);
			int opcao =Integer.parseInt(JOptionPane.showInputDialog(null,"Gostaria de ouvir o som: 1- rinxando ou 2-CORRE: "));
			if(opcao == 1) {
			...
			i = Integer.parseInt(a);
			Preguica.setIdade(i);
			int opcao =Integer.parseInt(JOptionPane.showInputDialog(null,"Gostaria de ouvir o som: 1- SOM DELA ou 2-CORRE: "));
			if(opcao == 1) {
